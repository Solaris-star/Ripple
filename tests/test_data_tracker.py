...
SCRIPT = Path(__file__).resolve().parents[1] / "skills/ripple/skill-data-tracker/scripts/track.py"


def load_module():
    spec = importlib.util.spec_from_file_location("ripple_data_tracker", SCRIPT)
