...
python3 skills/ripple/skill-publish-log/scripts/log.py record --platform 小红书 --title "标题" \
...
python3 skills/ripple/skill-publish-log/scripts/log.py query --platform 小红书 --since 2026-07-01 \
  [--until 2026-07-31] [--keyword AI] [--profile 画像名] [--latest] [--limit N]

# 统计（按 platform/type/month 聚合数量 + 互动总量 + 平均综合分）
python3 skills/ripple/skill-publish-log/scripts/log.py stat --by platform --since 2026-07-01
```
