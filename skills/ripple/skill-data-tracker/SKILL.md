...
```bash
python3 skills/ripple/skill-data-tracker/scripts/track.py snapshot --profile "科技数码达人" --platform xiaohongshu \
...
```bash
python3 skills/ripple/skill-data-tracker/scripts/track.py trend --profile "科技数码达人" --metric followers \
...
```bash
python3 skills/ripple/skill-data-tracker/scripts/track.py lifecycle --profile "科技数码达人" \
...
```bash
python3 skills/ripple/skill-data-tracker/scripts/track.py export-followers
```
