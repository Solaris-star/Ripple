...
```bash
python3 skills/ripple/skill-news-intelligence/scripts/fetch_news.py --source rss --limit 20 --keyword AI --no-save
```
...
```bash
python3 skills/ripple/skill-news-intelligence/scripts/daily_briefing.py --profile 科技账号 --no-save
```
