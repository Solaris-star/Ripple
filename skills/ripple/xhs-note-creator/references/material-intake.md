...
```bash
python3 skills/ripple/xhs-note-creator/scripts/analyze_material.py input.jpg \
...
```bash
python3 skills/ripple/xhs-note-creator/scripts/text_on_image.py input.jpg output.jpg \
  --text "一句钩子" \
  --position top \
  --fit 3x4 \
  --size 72 \
...
```bash
python3 skills/ripple/xhs-note-creator/scripts/collage_3x4.py output.jpg \
