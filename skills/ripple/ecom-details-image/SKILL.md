...
```bash
python3 skills/ripple/ecom-details-image/scripts/generate_image.py --prompt "..." --size 1:1 --resolution 2k
python3 skills/ripple/ecom-details-image/scripts/generate_image.py --prompt-file prompt.txt --output-dir outputs
python3 skills/ripple/ecom-details-image/scripts/generate_image.py --env-file .env --image product.jpg --prompt-file prompt.txt
```
