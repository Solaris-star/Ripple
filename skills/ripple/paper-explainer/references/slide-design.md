...
```bash
python skills/ripple/paper-explainer/scripts/render_slides.py validate \
  --plan outputs/<项目>/assets/slide-plan.json

python skills/ripple/paper-explainer/scripts/render_slides.py render \
  --plan outputs/<项目>/assets/slide-plan.json \
  --out-dir outputs/<项目>/assets/slides

python skills/ripple/paper-explainer/scripts/render_slides.py audit \
  --plan outputs/<项目>/assets/slide-plan.json \
