...
未指定模式时默认执行 A + B + C。模式 D 前先运行 `python3 skills/ripple/skill-data-tracker/scripts/track.py export-followers`。
...
```bash
python3 skills/ripple/skill-publish-analytics/scripts/analyze.py all
python3 skills/ripple/skill-publish-analytics/scripts/analyze.py --profile 画像名 time
python3 skills/ripple/skill-publish-analytics/scripts/analyze.py --profile 画像名 tags
python3 skills/ripple/skill-publish-analytics/scripts/analyze.py --profile 画像名 types
python3 skills/ripple/skill-publish-analytics/scripts/analyze.py --profile 画像名 growth
```
