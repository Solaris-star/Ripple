...
export default function SkillPage({ persona, onNavigate }: SkillPageProps) {
            ...
            <div className="skill-grid">
              {grouped[layer.key].map((s) => {
                ...
                return (
                  ...
                  >
                    {alert && <div className="skill-card-alert" title="依赖服务尚未就绪">!</div>}
                    ...
                    <div className="skill-card-foot">
                      {s.needsApi && (s.apiConfigured
                        ...
                        : <span className="badge badge-warn">待配置</span>)}
                      {s.structuredOperation && <span className="badge badge-ok">已接入 · {s.structuredOperation.label}</span>}
                    </div>
                  </div>
                );
              })}
