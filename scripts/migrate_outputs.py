...
PROJECT_ROOT = Path(os.environ.get("RIPPLE_ROOT") or Path(__file__).resolve().parents[1])
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--apply", action="store_true", help="真正回填 .ripple.json 展示头（否则 dry-run）")
